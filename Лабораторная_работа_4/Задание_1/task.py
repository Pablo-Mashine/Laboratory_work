...
class Machine:
    ...
    def __init__(self, make: str, model: str, year: int):
        ...
        Атрибуты непубличные, т.к. чтобы в будущем было проще сделать проверку
        на корректность присваевымых значений.
...
class Car(Machine):
    ...
    def engine(self) -> str:
        """
        Запускает двигатель автомобиля, выводит дополнительное сообщение о готовности ехать.

        :return: Сообщение о запуске двигателя и готовности ехать.
        """
        return f"{super().engine()} Ready to go!"   # Перегруженный метод
